 ...
 * @constructor
 * @param {String} imageContainerId the id of Html DIV which contains this image grid
 * @param {Number} gridWidth the width of this image grid
 */
YAHOO.ip.ImageGrid = function(imageContainerId, gridWidth, thumbnailType, isShowImageName, isShowImageUrl, isShowImageSize){
...
YAHOO.ip.ImageGrid.prototype = {
     ...
     * @param {String} thumbnailType "small","normal" and "large"
     */
     ...
     *
     * @method render
     * @param {List<ImageInfo>} imageList The list which contains all ImageInfo objects to render
     */
    render: function(imageList){
        ...
        YAHOO.ip.Logger.info("Creating Image Grid: gridWidth = " + this.gridWidth+", columnWidth = " + columnWidth + ", columnCount = " + columnCount + ", rowCount = " + rowCount);
