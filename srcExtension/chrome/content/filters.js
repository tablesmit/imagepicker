 ...
 * @constructor
 * @param {SizeFilter} sizeFilter the fiter for image size
 * @param {WidthFilter} widthFilter the fiter for image width
 * @param {HeightFilter} heightFilter the fiter for image height
 * @param {SkipImageTypeFilter} skipImageTypeFilter the fiter for image type
 */
...
YAHOO.ip.Filter.prototype = {
   ...
   /**
     ...
     * @param {Array<ImageInfo>} imageList a array which contains all ImageInfo objects to filter
 ...
 * @constructor
 * @param {Number} minSize the mim size of image can be acceptable
 * @param {Number} minSize the max size of image can be acceptable
 * @param {boolean} acceptNullSize a flag to controll if a image have null size can be acceptable
 */
...
YAHOO.ip.SizeFilter.prototype = {
   ...
   /**
     ...
     *
     * @method accept
     * @param {ImageInfo} imageInfo The ImageInfo object to check
    ...
    accept: function(imageInfo){
        ...
        if(this.acceptNullSize && (imageInfo.fileSize == null ||imageInfo.fileSize == 0)){
           ...
           // YAHOO.ip.Logger.info("this.minSize = " + this.minSize + ", this.maxSize = " + this.maxSize + ", fileSize=" + imageInfo.fileSize);
            return true;
        }
       // YAHOO.ip.Logger.info("imageInfo.fileSize > this.minSize = " + (imageInfo.fileSize > this.minSize));
 ...
 * @constructor
 * @param {Number} minWidth the mim width of image can be acceptable
 * @param {Number} minWidth the max width of image can be acceptable
 * @param {boolean} acceptNullWidth a flag to controll if a image have null width can be acceptable
 */
 ...
 * @constructor
 * @param {Number} minHeight the mim height of image can be acceptable
 * @param {Number} minHeight the max height of image can be acceptable
 * @param {boolean} acceptNullHeight a flag to controll if a image have null height can be acceptable
 */
 ...
 * @constructor
 * @param {Array<String>} imageTypes the array which contians all image types can be acceptable
 * @param {boolean} acceptNullImageType a flag to controll if a image have null(empty) image type can be acceptable
 */
 ...
 * @constructor
 * @param {Array<String>} skipImageTypes the array which contians all image types cannot be acceptable
 */
